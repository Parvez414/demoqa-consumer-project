...
public class DemoQaBrokenLinksImagesPage extends BasePage {
    ...
    protected void initElements() {
        register("validImage", "Valid demo image",
                By.xpath("//p[contains(text(),'Valid image')]/following-sibling::img[1] | //img[contains(@src,'Toolsqa.jpg')]"));
        register("brokenImage", "Broken demo image",
                By.xpath("//p[contains(text(),'Broken image')]/following-sibling::img[1]"));
        register("validLink", "Valid link navigation",
                By.xpath("//a[contains(text(),'Click Here for Valid Link')]"));
    ...
    public boolean isValidImageDisplayed() {
        ...
        try {
            WebElement img = waitForVisibility(getElement("validImage"), 8);
    ...
    public boolean isBrokenImageDetected() {
        ...
        try {
            WebElement img = waitForVisibility(getElement("brokenImage"), 8);
